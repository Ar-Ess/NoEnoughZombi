...
ParticleSystem::ParticleSystem(Render* render) : Module()
{
...
bool ParticleSystem::Start()
{
	...
	//particleAtlas = tex->Load(nameParticleAtlas.c_str());
...
{
	std::vector<Emitter*>::const_iterator it;
...
//pugi::xml_node ParticleSystem::LoadEmitters(pugi::xml_document& psystem_file)
//{
//	pugi::xml_node ret;
//
