...
App::App(int argc, char* args[]) : argc(argc), args(args)
{
	...
	AssetsManager* assets = new AssetsManager(RELEASE_MODE, "Assets.pak", render);
	AudioSystem* audio = new AudioSystem();
	GuiManager* gui = new GuiManager(input, render);
	SceneManager* scene = new SceneManager(render, input, win, gui, assets, audio);
